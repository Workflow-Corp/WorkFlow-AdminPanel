...
Write       mov #string, R7               ; Beli R7'yi clear yapmak gerekebilir
...
writeLoop   clr R6
            ...
            cmp.b #0Dh, R6    ;String'teki elimize aldigimiz char'in newline olup olmadigini kontrol ediyoruz.
            jeq newline
...
; wherestart'tan farkli olarak R4'un 1 oldugunu ogrendikten sonra yani asagidan basladigini ogrendikten sonra upper'a gidecek.
newline     bit.b #00000001b, R4
            jne upper
