(function ($) {
    ...
    var ctx = document.getElementById("group-line-chart");
    ...
    if (ctx) {
        ...
        {
            label: "Group Workload Per Revision Score",
        ...
        {
            label: "Group Workload Per Unit Time Score",
        ...
        {
            label: "Group Average Task Score",
